    ...
    >
      <div className="bg-[#1C1C1E] w-full max-w-lg rounded-t-[28px] border-t border-white/6">
        ...
        <div className="px-6 pb-8 space-y-4">
          {/* 카테고리 + 금액 */}
          <div className="bg-[#2C2C2E] rounded-3xl px-6 py-5 flex items-center gap-4">
            <div
            ...
            <div className="flex-1 min-w-0">
              ...
              <p className="text-[12px] text-[#4E5968] font-medium mt-1">
                {t.dateEnd
            ...
            <div className="bg-[#2C2C2E] rounded-2xl px-5 py-4 space-y-2">
              ...
              <div className="flex flex-wrap gap-2">
                {tags.map((tag) => (
                  <span
                    key={tag}
                    className="inline-flex items-center px-3 py-1.5 rounded-xl text-[12px] font-bold bg-[#3D8EF8]/15 text-[#3D8EF8]"
                  >
                    #{tag}
                  </span>
                ))}
          ...
          {t.receiptImageUrl && (
            <div className="bg-[#2C2C2E] rounded-2xl px-5 py-4 space-y-2">
              ...
              <div className="rounded-xl overflow-hidden border border-white/8">
                <img src={t.receiptImageUrl} alt="영수증" className="w-full" />
              </div>
            </div>
          )}
          ...
          <div className="flex gap-2 pt-1">
            <button
              ...
              className="flex-1 flex items-center justify-center gap-2 py-3.5 rounded-2xl font-bold text-[14px] bg-[#F25260]/15 text-[#F25260] hover:bg-[#F25260]/25 active:scale-[0.98] transition-all"
            >
              <Trash2 size={15} />
              삭제
            </button>
