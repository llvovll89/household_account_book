...
export default function MappingRowDetailModal({ row, headers, onClose }: Props) {
  return (
    ...
    >
      <div
        className="bg-[#1E2236] w-full max-w-lg rounded-t-[28px] border-t border-white/[0.06]"
      ...
      >
        ...
        <div className="px-6 pt-3 pb-8">
          ...
          <div className="max-h-[58vh] overflow-y-auto space-y-2 pr-0.5">
            {headers.map((h) => (
              <div key={h} className="rounded-xl border border-white/6 bg-[#252A3F]/70 px-4 py-3">
